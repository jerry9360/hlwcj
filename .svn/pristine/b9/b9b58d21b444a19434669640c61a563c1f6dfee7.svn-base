...
var closeform= function(){
	...
	var saveform=function(){
		$.ajax({
			type:"post",
			url:base+"/servicemgr/listmgr/save",
			data:$("#infoForm").serialize(),
			async:true,  
			success:function(data){
				if(data=="SUCCESS"){
					alert("保存成功！");
                   location.href=base + "/servicemgr/listmgr";
				}else{
					alert("保存失败！");
				}
			},
	...
	/* var editform=function(id){
		$.ajax({
			type:"get",
			url:base+"/servicemgr/listmgr/edit/"+id ,
			data:"",
			dataType:"json",
			success:function(data){
				if(data!=null){
	...
	var deleteinfo=function(id){
		$.ajax({
			type:"get",
			url:base+"/servicemgr/listmgr/delete/"+id ,
			data:"",
			dataType:"text",
			success:function(data){
				if(data=="SUCCESS"){
					alert("删除成功！");
                    window.location.href=base + "/servicemgr/listmgr";
				}else{
					alert("删除失败！");
				}
			},
