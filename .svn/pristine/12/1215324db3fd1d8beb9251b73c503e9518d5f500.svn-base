...
[@layout.main    modelcode=['fx_location' ]  otherjs=jss othercss=css  ]
[#include "common/loading.ftl"] 
<form class="form-horizontal" role="form" id="formid" action="${base}/analyzemgr/location" method="get"  autocomplete="off">
			<table class="table-form">
			<thead>
			<button class="btn btn-sm btn-primary" type="button" style="float:left;margin-top: 1px;" onclick="location.href='${base}/analyzemgr/location?time=0&'">近一周</button>
			<button class="btn btn-sm btn-primary" type="button" style="float:left;margin-top: 1px;margin-left:8px;" onclick="location.href='${base}/analyzemgr/location?time=1&'">近一个月</button>
			<button class="btn btn-sm btn-primary" type="button" style="float:left;margin-top: 1px;margin-left:8px;" onclick="location.href='${base}/analyzemgr/location?time=2&'">今年</button>
			<button class="btn btn-sm btn-primary" type="button" style="float:left;margin-top: 1px;margin-left:8px;" onclick="location.href='${base}/analyzemgr/location?time=3&'">去年</button>
...
<table  class="table  table-bordered table-hover">
	<thead>
		<tr>
			...
			<th style="width:30%;text-align:center;">地点名称</th>
	...
	<tbody>
		...
		<tr  >
			...
			<td ><a  href="${base}/analyzemgr/location/show?baddress=${corp[0]}&">${corp[0]}</a></td>
			<td>${corp[1]}</td>
			</td>
		</tr>
		[/#list]
