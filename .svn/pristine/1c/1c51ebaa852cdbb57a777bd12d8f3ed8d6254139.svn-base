...
function(t) {
    ...
    s = {
        ...
        headTemplate: '<thead><tr><th class="prev">＜<th colspan="4" class="switch"></th><th class="next">＞</th><th colspan="1" class="cleardate"><img src="'+base+'/assets/images/gbgb.png"></th></tr></thead>',
