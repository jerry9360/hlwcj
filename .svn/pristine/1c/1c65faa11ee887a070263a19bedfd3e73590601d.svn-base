...
[@layout.main  modelcode=['fx_illegal' ]  otherjs=jss othercss=css  ]
[#include "common/loading.ftl"] 
<form class="form-horizontal" role="form" id="formid" action="${base}/analyzemgr/illegalcarno" method="get"  autocomplete="off">
			<table class="table-form">
			<thead>
			<button class="btn btn-sm btn-primary" type="button" style="float:left;margin-top: 1px;" onclick="location.href='${base}/analyzemgr/illegalcarno?time=0&'">近一周</button>
			<button class="btn btn-sm btn-primary" type="button" style="float:left;margin-top: 1px;margin-left:8px;" onclick="location.href='${base}/analyzemgr/illegalcarno?time=1&'">近一个月</button>
			<button class="btn btn-sm btn-primary" type="button" style="float:left;margin-top: 1px;margin-left:8px;" onclick="location.href='${base}/analyzemgr/illegalcarno?time=2&'">今年</button>
			<button class="btn btn-sm btn-primary" type="button" style="float:left;margin-top: 1px;margin-left:8px;" onclick="location.href='${base}/analyzemgr/illegalcarno?time=3&'">去年</button>
...
<table  class="table  table-bordered table-hover">
	<thead>
		<tr>
			...
			<th style="width:20%;text-align:center;">相关工单数量</th>
		</tr>
	</thead>
	<tbody>
		[#list page as corp]
		<tr  >
			...
			<td ><a  href="${base}/analyzemgr/illegalcarno/show?carno=${corp[0]}&">${corp[0]}</a></td>
			<td>${corp[1]}</td>
			</td>
		</tr>
		[/#list]
