...
[@layout.main  modelcode=['fx_business' ]   otherjs=jss othercss=css  ]
[#include "common/loading.ftl"] 

<form class="form-horizontal" role="form" id="formid" action="${base}/analyzemgr/business" method="get"  autocomplete="off">
<div class="col-xs-12" >
