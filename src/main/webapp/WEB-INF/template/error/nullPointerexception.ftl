...
<html lang="zh-CN" class="no-js">
	...
	<body>
		...
		<div class="main-content" style="margin-left:0px;">
			...
			<div class="row">
				<div class="col-xs-12">
					<div id="errorMessage" class="alert alert-block alert-success" style="text-align:center;color:red;font-size: 30px;">
						空指针异常-nullPointerexception<br/><span style="font-size: 15px;"><a href="javascript:void(0);" onclick="window.history.go(-1)">返回</a></span>
					</div>
				</div>
			</div>
			</div>
