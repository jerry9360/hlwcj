...
[@layout.main modelcode=['fw_log' ]otherjs=jss othercss=css sername=['数据服务','服务日志']  ]

[#include "servicelogs/tanchu.ftl"]
<form class="form-horizontal" role="form" id="formid" action="${base}/servicemgr/logs" method="get"  autocomplete="off">
<div class="col-xs-12" >
<table class="table-form"  > 
	...
	<div class="col-xs-12" style="text-align:center;font-size:16px;font-weight: bold;padding-bottom: 10px;margin-top:10px;">数据服务日志统计</div>
		...
		<table class="table table-bordered table-hover"  >
			<thead>
				<tr>
					...
					<th style="width:5%;text-align:center;">接口名称 </th>
					[#if datelist??]
			...
			[#list tabletr as tr]
				<tr>
				 <td style="text-align:center;">${tr_index+1}</td>
					...
					<a class="btn btn-xs btn-primary"  onclick="editform('${log[5]}')"   href="javascript:void(0)">编辑</a>
					<a class="btn btn-xs btn-danger"   onclick="deleteinfo('${log[5]}')"   href="javascript:void(0)" >删除</a> -->
					[#list tr as td]
