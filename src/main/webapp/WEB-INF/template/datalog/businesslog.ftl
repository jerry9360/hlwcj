...
[@layout.main modelcode=['businessclean','cleanlog'] otherjs=jss othercss=css sername=['数据清洗','业务清洗日志']  ]
[#assign  tablewidth=(280+datelist?size*110)+'px']


<form class="form-horizontal" role="form" id="formid" action="${base}/logmgr/businesslog" method="get"  autocomplete="off">
<div class="col-xs-12" >
