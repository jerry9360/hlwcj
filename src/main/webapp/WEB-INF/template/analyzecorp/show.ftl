...
[#assign jss=[]] 
[@layout.main modelcode=['fx_dangan' ] otherjs=jss sername=['企业排名','企业相关信用信息'] pagename='信用信息']
...
<table class="table table-bordered dataTable no-footer">
	...
	[#if  datatype = 'judgedoc']
	 <thead>
		<tr>
			...
			<th style="width:20%;text-align:center;">文书标题</th>
			<th style="width:10%;text-align:center;">文书案号</th>
			<th style="width:10%;text-align:center;">发布日期</th>
			<th style="width:20%;text-align:center;">判决法院</th>
		</tr>
	</thead>
	<tbody>
		...
		<tr id="${judgedoc.id}">
			...
			<td style="word-break:break-all;">${judgedoc.hidcourt}</a></td>
		</tr>
		[/#list]
	</tbody>
	[/#if]
	...
	[#if  datatype = 'biaozhang' || datatype = 'huojiang'  || datatype = 'tongbaopiping']
	 <thead>
		<tr>
			...
			<th style="width:10%;text-align:center;">发布日期</th>
			<th style="width:20%;text-align:center;">源文日期</th>
		</tr>
	</thead>
	<tbody>
	...
	[#if  datatype = 'public_prise' || datatype = 'servicecomplaint'   ]
	 <thead>
		<tr>
			<th style="width:5%;text-align:center;">序号 </th>
			<th style="width:20%;text-align:center;">工单号</th>
			<th style="width:10%;text-align:center;">车牌号</th>
			<th style="width:10%;text-align:center;">发生时间</th>
			<th style="width:20%;text-align:center;">事件内容</th>
		</tr>
	</thead>
	<tbody>
	...
	<tbody>
		...
		[/#if]
			...
			<td style="word-break:break-all;"><a href = "${project.url}" target="view_window">${project.url}</a></td>
		</tr>
		[/#list]
	</tbody>
	[/#if]
