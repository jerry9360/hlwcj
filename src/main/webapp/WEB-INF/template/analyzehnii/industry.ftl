...
[@layout.main  modelcode=['fx_industry' ]   otherjs=jss othercss=css  ]
[#include "common/loading.ftl"] 

<form class="form-horizontal" role="form" id="formid" action="${base}/analyzemgr/industry" method="get"  autocomplete="off">
<div class="col-xs-12" >
