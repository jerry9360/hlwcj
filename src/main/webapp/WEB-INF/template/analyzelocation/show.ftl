...
[#assign jss=[]] 
[@layout.main modelcode=['fx_location' ]   otherjs=jss sername=['96096地点分析','涉及地点统计排名'] pagename='96096地点分析']
...
<table class="table table-bordered dataTable no-footer">
	<thead>
		<tr>
			...
			<th style="width:10%;text-align:center;">涉及地点</th>
...
[#assign pagepath="${base}/analyzemgr/location/show?baddress=${baddress}&"]  
