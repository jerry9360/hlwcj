[#assign jss=["assets/js/jquery.validate.min.js"]] 
...
<div class="row">
	<div class="col-xs-12">
		...
		<form class="form-horizontal" role="form" id="formid" action="${base}/xyjsmgr/sys/permission/save" method="post">
					 ...
					 <tr>
						...
						<td style="width:40%">
								<table id="sample-table-project" class="table   table-bordered  ">				
									...
									<tr>
										<td><input type="checkbox" class="roleid" name="roleid"   value="${role.id }" ></td>
										<td>${role.rolename }</td>
										<td>${role.rolecode }</td>
