...
[#assign jss=["assets/js/date-time/bootstrap-timepicker.min.js","assets/js/echarts/echarts.js","assets/js/Basestat.js"]]
 [@layout.main modelcode=['hnii_stat_dalei','96096_data'] otherjs=jss sername=['96096工单数据按业务大类统计'] pagename='统计分析']
 <div  class="table-responsive"  style="width:1688px;overflow-x: auto;">
  <div style="text-align: center;"><span style="font-weight: 600;font-size: 18px;">96096工单数据按大类统计</span></div>
		<table  class="table  table-bordered table-hover">
			<thead>
				<tr>
					...
					[#list roots  as root]
					<th style="text-align:center;" colspan="2" >${root.business_name}</th>
					[/#list]
				</tr>
				<tr>
  	...
  	<div id="dalei" class="col-xs-12" style="height:400px;padding:10px;">
	</div>
</div>		
...
var legend = ${rootstr}; 
$(function(){
	Basestat.createPilePie('dalei','工单数据按大类统计','采集年份',legend,xdata,ydata);
});
</script>	 																								
