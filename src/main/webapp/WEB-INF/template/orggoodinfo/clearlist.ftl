...
<div class="portlet box blue">
	...
	<div class="table-responsive">
		<form class="form-horizontal" role="form" id="formid" action="${base}/org/orggoodinfo/clear" method="get">
		...
		<table  class="table table-bordered table-hover">
			...
			<tbody>
				...
				<tr>
					...
					<td>
					[#if !orggoodinfo.state??]
					待处理
					[#elseif orggoodinfo.state=='2']
					不采信
					[#elseif orggoodinfo.state=='1']
					采信
					[/#if]
					</td>
 					<td><a  class="btn btn-xs btn-success" href="${base}/org/orggoodinfo/clear/${orggoodinfo.id}">处理</a></td>
				</tr>
				[/#list]
			</tbody>
		</table>
		[#assign pagepath="${base}/org/orggoodinfo/clear?orgname=${orgname}&type=${type}&source=${source}&"]  
