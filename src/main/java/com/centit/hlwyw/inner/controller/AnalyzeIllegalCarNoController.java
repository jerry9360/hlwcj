...
@Controller("analyzeIllegalCarNoController")
@RequestMapping("/analyzemgr/illegalcarno")
public class AnalyzeIllegalCarNoController  extends BaseController{
	
	private static Logger log = Logger.getLogger(AnalyzeIllegalCarNoController.class);
...
//			0 近一周  1  近一个月  2 今年  3 今年
			...
			List<Object> page = hnii_analyze_dataService.findIllegalCarnoDatas(begindate,enddate);
		...
		return "/analyzeillegalcarno/list";
	}
	...
	public String projectDetail(@RequestParam(required=false)  String carno,
		...
		return "/analyzeillegalcarno/show";
	}
